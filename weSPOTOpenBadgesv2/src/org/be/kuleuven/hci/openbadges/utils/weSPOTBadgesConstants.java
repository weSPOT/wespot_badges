...
public class weSPOTBadgesConstants {
	...
	public static final String KEYOPENBADGES = "{key}"; //App Engine key
	public static final String KEYELGG = "{key}"; //ELGG Api Key
	public static final String ARLEARNKEY = "{key}"; //ARLEARN key
